 ...
 * @returns {Uint8Array}
 */
export function add_metadata_to_image(image_data, metadata_json) {
    ...
    const ret = wasm.add_metadata_to_image(ptr0, len0, ptr1, len1);
    if (ret[3]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('turbo_exif_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
